...
class Draggable extends React.Component<DraggableProps, DraggableState> {
  ...
  canDrag: DraggableEventHandler = (e, coreData) => {
    if (this.props.canDrag) {
      return this.props.canDrag(e, createDraggableData(this, coreData));
    }
  };
  ...
  render(): ReactElement<any> {
    ...
    return (
      <DraggableCore {...draggableCoreProps} onStart={this.onDragStart} canDrag={this.canDrag} onDrag={this.onDrag} onStop={this.onDragStop}>
