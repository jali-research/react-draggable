...
export default class DraggableCore extends React.Component<DraggableCoreProps> {
  ...
  static propTypes: Object = {
     ...
     * If this function returns the boolean false, the next step of dragging will not
     * be processed, but dragging will not cancel.
     */
  ...
  handleDrag: EventHandler<MouseTouchEvent> = (e) => {
    ...
    const shouldSkipUpdate = this.props.canDrag(e, coreEvent);
